  ...
  return (
    <>
      <motion.nav 
        ...
        className="fixed top-0 left-0 right-0 z-40 backdrop-blur-lg w-full"
      >
        <div className="mx-auto px-4 sm:px-8 py-4 sm:py-6 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-4 xl:gap-8 flex-1 justify-center">
            {navLinks.map((link) => (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`text-xs sm:text-sm font-medium transition-all duration-300 pb-1 border-b-2 whitespace-nowrap ${
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div className="hidden sm:flex items-center gap-3 sm:gap-4 text-lg sm:text-2xl">
              {/* LinkedIn */}
              <motion.a 
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              className="lg:hidden text-xl sm:text-2xl text-neutral-300 hover:text-purple-400 transition-colors"
            >
        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 h-full w-64 bg-neutral-950 border-l border-neutral-800 z-40 lg:hidden pt-24 px-6 overflow-y-auto"
            >
              <div className="flex flex-col gap-4">
                {navLinks.map((link) => (
                  <motion.button
                    ...
                    onClick={() => scrollToSection(link.id)}
                    whileTap={{ scale: 0.95 }}
                    className={`text-left text-base font-medium transition-all duration-300 pb-2 border-b-2 ${
                      activeSection === link.id
                        ? "text-purple-400 border-purple-500"
                        : "text-neutral-300 border-transparent hover:text-purple-400"
                    }`}
